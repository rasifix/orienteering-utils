...
module.exports.serialize = function(event) {
    ...
    event.categories.forEach(function(category) {
        ...
        category.runners.forEach(function(runner) {
            result += [runner.rank, runner.name, runner.surname, runner.yearOfBirth, runner.sex, '', runner.zip, runner.city, runner.club, runner.nation, '', runner.ecard, runner.time, runner.startTime, ''].join(';');
